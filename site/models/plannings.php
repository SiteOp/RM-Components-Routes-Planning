...
class Routes_planningModelPlannings extends \Joomla\CMS\MVC\Model\ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->select(array('COUNT(CASE WHEN cg.id_grade_filter = 10 then 1 ELSE NULL END) as  ist_grade_10',
						     'COUNT(CASE WHEN cg.id_grade_filter = 11 then 1 ELSE NULL END) as  ist_grade_11',
							 'COUNT(CASE WHEN cg.id_grade_filter = 12 then 1 ELSE NULL END) as  ist_grade_12',
							 'COUNT(CASE WHEN cg.id_grade_filter = 13 then 1 ELSE NULL END) as  ist_grade_13',
							 'COUNT(CASE WHEN cg.id_grade_filter = 14 then 1 ELSE NULL END) as  ist_grade_14',
							 'COUNT(CASE WHEN cg.id_grade_filter = 15 then 1 ELSE NULL END) as  ist_grade_15',
							 'COUNT(CASE WHEN cg.id_grade_filter = 16 then 1 ELSE NULL END) as  ist_grade_16',
							 'COUNT(CASE WHEN cg.id_grade_filter = 17 then 1 ELSE NULL END) as  ist_grade_17',
							 'COUNT(CASE WHEN cg.id_grade_filter = 18 then 1 ELSE NULL END) as  ist_grade_18',
							 'COUNT(CASE WHEN cg.id_grade_filter = 19 then 1 ELSE NULL END) as  ist_grade_19',
							 'COUNT(CASE WHEN cg.id_grade_filter = 20 then 1 ELSE NULL END) as  ist_grade_20',
							 'COUNT(CASE WHEN cg.id_grade_filter = 21 then 1 ELSE NULL END) as  ist_grade_21',
							 'COUNT(CASE WHEN cg.id_grade_filter = 22 then 1 ELSE NULL END) as  ist_grade_22',
							 'COUNT(CASE WHEN cg.id_grade_filter = 23 then 1 ELSE NULL END) as  ist_grade_23',
							 'COUNT(CASE WHEN cg.id_grade_filter = 24 then 1 ELSE NULL END) as  ist_grade_24',
							 'COUNT(CASE WHEN cg.id_grade_filter = 25 then 1 ELSE NULL END) as  ist_grade_25',
							 'COUNT(CASE WHEN cg.id_grade_filter = 26 then 1 ELSE NULL END) as  ist_grade_26',
							 'COUNT(CASE WHEN cg.id_grade_filter = 27 then 1 ELSE NULL END) as  ist_grade_27',
							 'COUNT(CASE WHEN cg.id_grade_filter = 28 then 1 ELSE NULL END) as  ist_grade_28',
							 'COUNT(CASE WHEN cg.id_grade_filter = 29 then 1 ELSE NULL END) as  ist_grade_29',
							 'COUNT(CASE WHEN cg.id_grade_filter = 30 then 1 ELSE NULL END) as  ist_grade_30',
							 'COUNT(CASE WHEN cg.id_grade_filter = 31 then 1 ELSE NULL END) as  ist_grade_31',
							 'COUNT(CASE WHEN cg.id_grade_filter = 32 then 1 ELSE NULL END) as  ist_grade_32',
							 'COUNT(CASE WHEN cg.id_grade_filter = 33 then 1 ELSE NULL END) as  ist_grade_33',
							 'COUNT(CASE WHEN cg.id_grade_filter = 34 then 1 ELSE NULL END) as  ist_grade_34',
							 'COUNT(CASE WHEN cg.id_grade_filter = 35 then 1 ELSE NULL END) as  ist_grade_35',
							 'COUNT(CASE WHEN cg.id_grade_filter = 36 then 1 ELSE NULL END) as  ist_grade_36',
							 'COUNT(CASE WHEN cg.id_grade_filter = 37 then 1 ELSE NULL END) as  ist_grade_37',
							 'COUNT(CASE WHEN cg.id_grade_filter = 38 then 1 ELSE NULL END) as  ist_grade_38',
							 'COUNT(CASE WHEN cg.id_grade_filter = 39 then 1 ELSE NULL END) as  ist_grade_39',
							 'COUNT(CASE WHEN cg.id_grade_filter = 40 then 1 ELSE NULL END) as  ist_grade_40',
							 'COUNT(CASE WHEN cg.id_grade_filter = 41 then 1 ELSE NULL END) as  ist_grade_41',
							 'COUNT(CASE WHEN cg.id_grade_filter = 42 then 1 ELSE NULL END) as  ist_grade_42',
							 'COUNT(CASE WHEN cg.id_grade_filter = 43 then 1 ELSE NULL END) as  ist_grade_43',
							 'COUNT(CASE WHEN cg.id_grade_filter = 44 then 1 ELSE NULL END) as  ist_grade_44',
							 'COUNT(CASE WHEN cg.id_grade_filter = 45 then 1 ELSE NULL END) as  ist_grade_45',
							 'COUNT(CASE WHEN cg.id_grade_filter = 46 then 1 ELSE NULL END) as  ist_grade_46',
							 'COUNT(CASE WHEN cg.id_grade_filter = 47 then 1 ELSE NULL END) as  ist_grade_47',
							 'COUNT(CASE WHEN cg.id_grade_filter = 48 then 1 ELSE NULL END) as  ist_grade_48',
							 'COUNT(CASE WHEN cg.id_grade_filter = 49 then 1 ELSE NULL END) as  ist_grade_49',
							 'COUNT(CASE WHEN cg.id_grade_filter = 50 then 1 ELSE NULL END) as  ist_grade_50',
							 'COUNT(CASE WHEN cg.id_grade_filter = 51 then 1 ELSE NULL END) as  ist_grade_51',
							 'COUNT(CASE WHEN cg.id_grade_filter = 52 then 1 ELSE NULL END) as  ist_grade_52',
							 'COUNT(CASE WHEN cg.id_grade_filter = 53 then 1 ELSE NULL END) as  ist_grade_53',
